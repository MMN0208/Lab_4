                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="#r">Register</a>
                            </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="card shadow-2-strong" style="border-radius: 1rem;">
                                <div class="card-body p-5 text-center">
                                    ...
                                    <div class="form-floating mb-5">
                                        <input type="password" class="form-control form-control-lg" id="floatingPassword2" placeholder="Confirm password">
